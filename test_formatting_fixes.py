#!/usr/bin/env python3
"""
Comprehensive test for single-source modal formatting fixes.
"""
...
def test_formatting_fixes():
    """Test the formatting fixes for single-source modal."""
    print("🧪 Testing comprehensive formatting fixes...")
    ...
    # Test principal_findings formatting
