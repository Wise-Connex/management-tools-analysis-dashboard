...
def validate_dashboard_content(tool_name, selected_sources, language):
    ...
    try:
        ...
        if not analysis_data:
            return {"success": False, "error": "Analysis data is empty or invalid JSON"}

        # Check required sections (dashboard validation logic)
        required_sections = [
            "executive_summary",
            "principal_findings",
            "temporal_analysis",
...
def main():
    ...
    output_file = "/Users/Dimar/Documents/python-code/MTSA/tools-dashboard/dashboard_validation_result.json"
