...
main_cursor.execute("""
    SELECT tool_name, selected_sources, language, executive_summary, principal_findings,
           temporal_analysis, seasonal_analysis, fourier_analysis, pca_insights,
           confidence_score, model_used, data_points_analyzed, analysis_depth
...
for i, report in enumerate(test_reports, 1):
    (tool_name, selected_sources, language, executive_summary, principal_findings,
     temporal_analysis, seasonal_analysis, fourier_analysis, pca_insights,
     confidence_score, model_used, data_points_analyzed, analysis_depth) = report
